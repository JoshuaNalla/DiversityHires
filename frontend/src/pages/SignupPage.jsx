...
const SignupPage = () => {
    ...
    return (
        <div 
            className="brand-shell min-h-screen flex items-center justify-center p-4"
            style={{ fontFamily: "'Inter', sans-serif" }}
        >
            {/* BEGIN: SignUpCard */}
            <main className="brand-card w-full max-w-[460px] rounded-[2rem] p-8 sm:p-10" data-purpose="sign-up-container">
                {/* Header */}
                <header className="mb-8 text-center">
                    ...
                    <p className="text-sm text-on-surface-variant mt-2">Start practicing with a cleaner, smarter interview workflow.</p>
                </header>
                ...
                <form className="space-y-5" data-purpose="sign-up-form" onSubmit={handleSubmit}>
                    ...
                    <div data-purpose="form-group-name">
                        ...
                        <input 
                            className="w-full px-4 py-3 bg-white text-[#333] placeholder-gray-500 rounded-xl border border-outline-variant focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition duration-200" 
                            id="fullName" 
                            name="fullName" 
                    ...
                    <div data-purpose="form-group-password">
                        ...
                        <div className="relative">
                            <input 
                                className="w-full px-4 py-3 bg-white text-[#333] placeholder-gray-500 rounded-xl border border-outline-variant focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition duration-200 pr-12" 
                                id="password" 
                                name="password" 
                ...
                <footer className="mt-8 text-center" data-purpose="sign-up-footer">
                    <p className="text-sm text-on-surface-variant">
                        ...
                        <Link className="text-primary hover:underline font-medium" to="/login">Sign in here</Link>
                    </p>
                </footer>
            </main>
            {/* END: SignUpCard */}
