            ...
            >
                ...
                <div className="p-8 md:p-10">
                    ...
                    <div className="mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-on-background tracking-tight">Create an account</h2>
                        <p className="text-sm text-on-surface-variant mt-1">Start your interview prep journey today</p>
                    </div>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        <div>
                            <label className="block text-[11px] font-semibold uppercase tracking-wider text-on-surface-variant mb-2">Full Name</label>
                            <input
                                type="text"
                                required
                                value={fullName}
                        ...
                        <div>
                            <label className="block text-[11px] font-semibold uppercase tracking-wider text-on-surface-variant mb-2">Password</label>
                            <input
                                type="password"
                                required
                                value={password}
                    ...
                    <div className="my-6 flex items-center gap-3">
                        ...
                        <span className="text-xs text-outline font-medium">or sign up with</span>
                        <div className="flex-1 h-px" style={{ background: '#1e293b' }} />
                    </div>
                    ...
                    <div className="space-y-3">
                        <button
                            type="button"
                            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl text-sm font-medium text-on-surface"
                            style={{ background: '#0c1220', border: '1px solid #1e293b', transition: 'border-color 0.15s ease' }}
